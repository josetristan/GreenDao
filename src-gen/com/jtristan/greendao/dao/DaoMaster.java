...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        LineaDao.createTable(db, ifNotExists);
        CondicionPagoDao.createTable(db, ifNotExists);
        CondicionPagoDeUnPedidoDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        PedidoDao.dropTable(db, ifExists);
        LineaDao.dropTable(db, ifExists);
        CondicionPagoDao.dropTable(db, ifExists);
        CondicionPagoDeUnPedidoDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(CondicionPagoDao.class);
        registerDaoClass(CondicionPagoDeUnPedidoDao.class);
    }
